...
The tool appends the provided `fact` to a special `GEMINI.md` file located in the user's home directory (`~/.iflycode/GEMINI.md`). This file can be configured to have a different name.
